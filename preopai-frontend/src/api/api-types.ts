...
export class HttpClient<SecurityDataType = unknown> {
  ...
  public setHospitalId = (hospitalId: string) => {
...
> extends HttpClient<SecurityDataType> {
  ...
  forms = {
    ...
    formsFormExportList: (id: string, params: RequestParams = {}) =>
      this.request<Blob, any>({
        ...
        method: "GET",
        secure: true,
        format: "blob", // 👈 critical: ensures binary data is returned
        ...params,
      }),
  ...
  surgeries = {
     ...
     * @tags surgeries
     * @name SurgeriesList
     * @request GET:/surgeries/
     * @secure
     */
    surgeriesList: (params: RequestParams = {}) =>
      this.request<Surgery[], any>({
        path: `/surgeries/`,
        method: "GET",
        secure: true,
        format: "json",
     ...
     *
     * @tags surgeries
     * @name SurgeriesCreateCreate
     * @request POST:/surgeries/create/
     * @secure
     */
    surgeriesCreateCreate: (data: SurgeryCreate, params: RequestParams = {}) =>
      this.request<PatientCreate, any>({
     ...
     * @tags surgeries
     * @name SurgeryRead
     * @request GET:/surgeries/{id}/
     * @secure
     */
    surgeriesRead: (id: string, params: RequestParams = {}) =>
      this.request<Surgery, any>({
        path: `/surgeries/${id}/`,
        method: "GET",
        secure: true,
     ...
     *
     * @tags surgeries
     * @name SurgeryUpdateCreate
     * @request POST:/surgeries/{id}/update/
     * @secure
     */
    surgeriesUpdateCreate: (
      id: string,
      data: SurgeryUpdate,
      params: RequestParams = {},
    ) =>
      this.request<SurgeryUpdate, any>({
        path: `/surgeries/${id}/update/`,
        method: "PUT",
        body: data,
        secure: true,
        type: ContentType.Json,
